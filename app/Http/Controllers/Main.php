...
class Main
{
    ...
    public static function getUserFioAll($row, $type = 0) {

        return self::getUserFio($row->firstname ?? false, $row->lastname ?? false, $row->fathername ?? false, $type);
    ...
    /**
     * Преобразование гос.номера из кирилицы в латиницу
     */
    public static function transliterateGosNum($str) {

        $rus = array('А', 'В', 'Е', 'К', 'М', 'Н', 'О', 'Р', 'С', 'Т', 'У', 'Х', 'а', 'в', 'е', 'к', 'м', 'н', 'о', 'р', 'с', 'т', 'у', 'х');

        $lat = array('A', 'B', 'E', 'K', 'M', 'H', 'O', 'P', 'C', 'T', 'Y', 'X', 'A', 'B', 'E', 'K', 'M', 'H', 'O', 'P', 'C', 'T', 'Y', 'X');
